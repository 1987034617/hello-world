...
@interface HomeTVDetailController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,HomeTVDetailFooterViewDelegate>
...
@implementation HomeTVDetailController
...
- (void)viewDidLoad {
    ...
    if (self.isHome == NO) {
        self.collectionView.frame = CGRectMake(0, JYSafeAreaTopHeight, self.view.bounds.size.width, self.view.bounds.size.height - JYSafeAreaTopHeight - JYSafeAreaBottomHeight - 70);
        ...
        self.collectionView.frame = CGRectMake(0, JYSafeAreaTopHeight, self.view.bounds.size.width, self.view.bounds.size.height - JYSafeAreaTopHeight - JYSafeAreaBottomHeight);
    }
    [self loadData];
    ...
    [Networking networkingGET:[NSString stringWithFormat:@"http://www.huilink.com.cn/dk2018/getkeylist.asp?mac=afc1d387b4ab661d&kfid=%@",self.typeDict[@"id"]] parameters:nil completedBlock:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        if (dict) {
            ...
            if (keyModel.keylist.count>0) {
                ...
                weakSelf.arr = keyModel.keyvalue;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    [SVProgressHUD showInfoWithStatus:self.arr[indexPath.item]];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, JYSafeAreaTopHeight, self.view.bounds.size.width, self.view.bounds.size.height - JYSafeAreaTopHeight - JYSafeAreaBottomHeight - 70) collectionViewLayout:flow];
